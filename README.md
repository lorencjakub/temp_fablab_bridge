...
Get active (not expired) trainings of specific user for UI section "Absolved trainings".
		...
		Data from response used in bridge function:
			{
				...
				"lockVersion": 1,
				 "metadata": {
					"failed_courses": [
						{"id": 123, "title": "Test2", "attempts": 1}
					]
				},
				"_embedded": {
					"trainings": [
						{"id": 135, "lockVersion": 1, "trainingCourse": 456, "untilDate": null}
					],
  ...
  TRY IT!
  https://fablab-bridge-production.up.railway.app/apidocs/#/absolved-trainings/get_absolved_trainings__member_id_
